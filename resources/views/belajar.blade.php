...
<h1 class="font-semibold text-2xl">Data Siswa SMKN 4 BANDUNG</h1>

<a href="{{ url('/siswa/create') }}" class="btn btn-primary mb-3">
...
<table class="table table-striped  table-hover ">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{ url('/siswa/edit/' . $row->id) }}" class="btn btn-success">
